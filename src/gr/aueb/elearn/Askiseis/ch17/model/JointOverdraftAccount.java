...
public class JointOverdraftAccount extends AbstractEntity implements IdentifiableEntity {
    ...
    public JointOverdraftAccount(long id, User firstHolder, User secondHolder, String iban, double balance) {
        super.setId(id);
