 ...
 * **/
    public void withdraw (double amount ,String ssn) throws Exception {
        if (!isSSnVald(ssn)){
            logErrorMessage(new PrintStream("C:\\Users\\Mutantin\\Desktop\\KEDIVIM\\java\\logAccount.txt"),"Invalid ssn!");
            return;
        }
        if (amount <= balance){
            balance -= amount;
            ...
            try {
                ...
                logErrorMessage(new PrintStream("C:\\Users\\Mutantin\\Desktop\\KEDIVIM\\java\\logAccount.txt"),"Insufficient balance");
                throw e;
            }
        }
    }
